...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentMenu=__webpack_require__(171);
	...
	ReactDOM.render(React.createElement(ComponentMenu, null),document.getElementById("menu"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentLogin=__webpack_require__(173).root;
	var ComponentLoginHeader=__webpack_require__(173).header;
	var ComponentLoginBody=__webpack_require__(173).body;

	var ComponentRegister=__webpack_require__(174).root;
	var ComponentRegisterHeader=__webpack_require__(174).header;
	var ComponentRegisterBody=__webpack_require__(174).body;
	...
	var ComponentHeader=React.createClass({displayName: "ComponentHeader",
		handleClick:function(event){
			...
			switch(_title){
				case 'login':
				 ReactDOM.render(React.createElement(ComponentLogin, null),document.getElementById("banner"));
				 
				 ReactDOM.render(React.createElement(ComponentLoginHeader, null),document.getElementById("loginHeader"));
				 ReactDOM.render(React.createElement(ComponentLoginBody, null),document.getElementById("loginBody"));
				break;
				case 'register':
				 ReactDOM.render(React.createElement(ComponentRegister, null),document.getElementById("banner"));
				 ReactDOM.render(React.createElement(ComponentRegisterHeader, null),document.getElementById("registerHeader"));
				 ReactDOM.render(React.createElement(ComponentRegisterBody, null),document.getElementById("registerBody"));
				break;
			}
		...
		render:function(){
			...
			return(
				React.createElement("div", {style: _style._style}, 
				  React.createElement("div", {style: _style._img_div}, 
				    React.createElement("img", {style: _style._img_stlye, src: _img})
				  ), 
				  React.createElement("div", {style: _style._user_div}, 
				      React.createElement("div", {onClick: this.handleClick, title: "register", style: _style._user_div_register}, "注册"), 
				      React.createElement("div", {onClick: this.handleClick, title: "login", style: _style._user_div_login}, "登录")
				  )
				)
			);
		}
				    ...
				    React.createElement("div", {className: "swiper-container"}, 
					    React.createElement("div", {className: "swiper-wrapper"}, 
					        React.createElement("div", {className: "swiper-slide"}, 
							     React.createElement("img", {style: _style.img, className: "swiper-img", src: "img/1.png"})
						    ), 
						     React.createElement("div", {className: "swiper-slide"}, 
							     React.createElement("img", {style: _style.img, className: "swiper-img", src: "img/2.png"})
						    )
					    ), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React=__webpack_require__(1);
	var ComponentMenu=React.createClass({displayName: "ComponentMenu",
		render:function(){
			return(
				React.createElement("div", null, 
				 "this is menu"
		...
		render:function(){
			...
			return(
				React.createElement("div", {style: _s.div}, 
				   ...
				   React.createElement("div", {style: _s._div, onClick: this.handleClick, title: "classfy"}, "赚钱"), 
				   React.createElement("div", {style: _s._div, onClick: this.handleClick, title: "shopcar", title: "shopcar"}, "榜单"), 
				   React.createElement("div", {style: _s._div, onClick: this.handleClick, title: "myshow", title: "myshow"}, "我的")
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentRegisterHeader=__webpack_require__(174).header;
	var ComponentRegisterBody=__webpack_require__(174).body;
	var ComponentRegisterBodyNext=__webpack_require__(174).next;
	...
	/**登录组件的header 开始***/
	var ComponentLoginHeader=React.createClass({displayName: "ComponentLoginHeader",
		render:function(){
			var _css=this.CSS;
			var _back="<";
			return(
				React.createElement("div", {style: _css.div}, 
				   React.createElement("div", {style: _css.back}, _back), 
				   React.createElement("div", {style: _css.font}, "账户登录")
				)
			);
		}
	});
	...
	/**登录组件的body 开始***/
	var ComponentLoginBody=React.createClass({displayName: "ComponentLoginBody",
		handleClick:function(event){
		    ...
		    switch(_t){
				case "forgetpwd":
				 ReactDOM.render(React.createElement(ComponentFindPwdHeader, null),document.getElementById("loginHeader"));
				 ReactDOM.render(React.createElement(ComponentFindPwdBody, null),document.getElementById("loginBody"));
				break;
			...
			return(
				React.createElement("div", {style: _css.div}, 
				   React.createElement("div", {style: _css.input}, 
				     React.createElement("input", {type: "text", placeholder: "手机号/用户名/邮箱", style: _css.inputs})
				   ), 
				   
				   React.createElement("div", {style: _css.input}, 
				     React.createElement("input", {type: "text", placeholder: "登录密码", style: _css.inputs})
				   ), 
				   React.createElement("div", {style: _css.btn}, "登录"), 
				   React.createElement("div", {style: _css.aggre}, 
				      React.createElement("span", {title: "forgetpwd", onClick: this.handleClick, style: _css.span}, "忘记密码"), 
				      React.createElement("span", {style: _css.span}, "|"), 
				      React.createElement("span", {title: "register", onClick: this.handleClick, style: _css.span}, "快速注册")
				   )
				)
			);
		}
	...
	var ComponentFindPwdHeader=React.createClass({displayName: "ComponentFindPwdHeader",
		render:function(){
			var _css=this.CSS;
			var _back="<";
			return(
				React.createElement("div", {style: _css.div}, 
				   React.createElement("div", {style: _css.back}, _back), 
				   React.createElement("div", {style: _css.font}, "找回密码")
				)
			);
		}
	});
	...
	var ComponentFindPwdBody=React.createClass({displayName: "ComponentFindPwdBody",
		handleClick:function(event){
			ReactDOM.unmountComponentAtNode(document.getElementById("loginHeader"));
			ReactDOM.unmountComponentAtNode(document.getElementById("loginBody"));
			ReactDOM.render(React.createElement(ComponentFindPwdSafeHeader, null),document.getElementById("loginHeader"));
			ReactDOM.render(React.createElement(ComponentFindPwdSafeBody, null),document.getElementById("loginBody"));
		},
		render:function(){
			var _css=this.CSS;
			return(
				React.createElement("div", {style: _css.div}, 
				   ...
				   React.createElement("div", {onClick: this.handleClick, style: _css.btn}, "下一步")
				)
			);
		}
	});
	...
	var ComponentFindPwdSafeBody=React.createClass({displayName: "ComponentFindPwdSafeBody",
		handleClick:function(){
			//ComponentLoginNewPwdHeader
			ReactDOM.unmountComponentAtNode(document.getElementById("loginHeader"));
			ReactDOM.unmountComponentAtNode(document.getElementById("loginBody"));
			ReactDOM.render(React.createElement(ComponentLoginNewPwdHeader, null),document.getElementById("loginHeader"));
			ReactDOM.render(React.createElement(ComponentLoginNewPwdBody, null),document.getElementById("loginBody"));
		},
		render:function(){
			var _css=this.CSS;
			return(
				React.createElement("div", {style: _css.div}, 
				   React.createElement("div", {style: _css.tool}, 
				      "请输入手机号152#####6915的验证码"
				   ), 
				   React.createElement("div", {style: _css.input}, 
				     React.createElement("input", {type: "text", placeholder: "短信验证码", style: _css.inputs})
				   ), 
				   React.createElement("div", {onClick: this.handleClick, style: _css.btn}, "下一步")
				)
			);
	...
	var ComponentFindPwdSafeHeader=React.createClass({displayName: "ComponentFindPwdSafeHeader",
		render:function(){
			var _css=this.CSS;
			var _back="<";
			return(
				React.createElement("div", {style: _css.div}, 
				   React.createElement("div", {style: _css.back}, _back), 
				   React.createElement("div", {style: _css.font}, "安全校验")
				)
			);
		}
	});
	...
	var ComponentLoginNewPwdHeader=React.createClass({displayName: "ComponentLoginNewPwdHeader",
		render:function(){
			var _css=this.CSS;
			var _back="<";
			return(
				React.createElement("div", {style: _css.div}, 
				   React.createElement("div", {style: _css.back}, _back), 
				   React.createElement("div", {style: _css.font}, "设置新密码")
				)
			);
		}
	});
	...
	var ComponentLoginNewPwdBody=React.createClass({displayName: "ComponentLoginNewPwdBody",
		render:function(){
			var _css=this.CSS;
			return(
				React.createElement("div", {style: _css.div}, 
				   React.createElement("div", {style: _css.input}, 
				     React.createElement("input", {type: "text", placeholder: "输入新密码", style: _css.inputs})
				   ), 
				   
				   React.createElement("div", {style: _css.input}, 
				     React.createElement("input", {type: "text", placeholder: "确认密码", style: _css.inputs})
				   ), 
				   React.createElement("div", {style: _css.btn}, "登录")
...
/***/ function(module, exports, __webpack_require__) {
		...
		render:function(){
			return(
				React.createElement("div", null, 
				   ...
				   React.createElement("div", {id: "registerBody"})
				)
			);
		}
	});
	...
	/**注册组件的header 开始**/
	var ComponentRegisterHeader=React.createClass({displayName: "ComponentRegisterHeader",
		render:function(){
			var _css=this.CSS;
			var _back="<";
			return(
				React.createElement("div", {style: _css.div}, 
				   React.createElement("div", {style: _css.back}, _back), 
				   React.createElement("div", {style: _css.font}, "注册")
				)
			);
		}
	});
	...
	/**注册组件的body 开始**/
	var ComponentRegisterBody=React.createClass({displayName: "ComponentRegisterBody",
		handleClick:function(event){
			
			ReactDOM.unmountComponentAtNode(document.getElementById("registerBody"));
			ReactDOM.render(React.createElement(ComponentRegisterBodyNext, null),document.getElementById("registerBody"));
		},
		render:function(){
			var _css=this.CSS;
			return(
				React.createElement("div", {style: _css.div}, 
				   React.createElement("div", {style: _css.tool}, 
				      React.createElement("div", {style: _css.toolOne}, 
				         "我要钱"
				      ), 
				      React.createElement("div", {style: _css.toolTwo}, 
				         "我要流量"
				      )
				   ), 
				   React.createElement("div", {style: _css.input}, 
				     React.createElement("input", {type: "text", placeholder: "请输入手机号", style: _css.inputs})
				   ), 
				   React.createElement("div", {onClick: this.handleClick, style: _css.btn}, "下一步"), 
				   React.createElement("div", {style: _css.aggre}, "是否同意条款", React.createElement("span", {style: _css.span}, "平台服务协议"))
				)
			);
		}
	});
	...
	/**注册组件的下一步  开始**/
	var ComponentRegisterBodyNext=React.createClass({displayName: "ComponentRegisterBodyNext",
		render:function(){
			var _css=this.CSS;
			return(
				React.createElement("div", {style: _css.div}, 
				   ...
				   React.createElement("div", {style: _css.input}, 
				     React.createElement("input", {type: "text", placeholder: "请输入验证码", style: _css.inputs})
				   ), 
				   React.createElement("div", {onClick: this.handleClick, style: _css.btn}, "完成"), 
				   React.createElement("div", {style: _css.aggre}, "是否同意条款", React.createElement("span", {style: _css.span}, "平台服务协议"))
				)
			);
		}
